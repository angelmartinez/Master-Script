...
fout = open(FILE_LOCATION+brand+'_pta.csv', 'w')
...
print("PTA=DONE #owned...As chris would say, 'MY MAN'!!")
print("")

print("If you want to run the script again, just hit the UP arrow on your directional pad and hit ENTER")
print("")
